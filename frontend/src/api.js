...
/**
 * Decode JWT token payload in pure JavaScript without external packages.
 */
...
/**
 * Custom request wrapper that handles Authorization header injection and automatic token refresh.
 */
